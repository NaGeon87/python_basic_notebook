...
# 1.메뉴와 가격표
###############
buger_name = {1: "몬스터와퍼", 2: "빅맥", 3: "싸이버거"}
side_name = {1: "감자튀김", 2: "치즈스틱", 3: "치킨너겟"}
drink_name = {1: "사이다", 2: "콜라", 3: "환타"}

buger_price = {1: 7000, 2: 5000, 3: 4000}
...
if menu_num == 1:  # 세트
    ...
    print("■" * 50)
    # 1.햄버거 메뉴 출력
    for key, value in buger_name.items():
        print(f"□ {key}.{value}")
    # 2.햄버거 메뉴 선택
    while True:
        menu_num = int(input(">> 번호: "))
    ...
    # 3.선택한 메뉴 저장
    menu_save["buger"] = buger_name[menu_num]
    price_save["buger"] = buger_price[menu_num]
elif menu_num == 3:  # 사이드
    pass
elif menu_num == 4:  # 음료
    pass
